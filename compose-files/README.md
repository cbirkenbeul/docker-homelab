...
| [bookstack](bookstack) | Bookstack is a wiki system | null | null |
...
| [Nextcloud](Nextcloud) | Host your own cloud | null | null |
| [ntp-server](ntp-server) | Host your own central NTP Server | null | null |
| [PHP-IPAM](PHP-IPAM) | Manage your IP-Subnets and document them in one single application | null | null |
...
| [Scrutiny](Scrutiny) | If you like to get more SMART Information from your harddisks, you need to use Scrutiny | null | null |
...
| [Uptime Kuma](Uptime Kuma) | Uptime Kuma let you monitor the reachability of your (web)applications. | null | null |
| [Vaultwarden](Vaultwarden) | Vaultwarden (prev. bitwarden_rs) is a lightwight version of Bitwarden | null | null |
